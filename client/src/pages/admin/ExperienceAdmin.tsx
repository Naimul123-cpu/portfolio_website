                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                      ...
                      <div className="space-y-8">
                        <div className="space-y-3">
                          ...
                          <textarea name="description" value={formData.description} onChange={handleInputChange} rows={5} className="w-full glass bg-white/5 border border-white/10 rounded-[32px] p-6 text-text-primary outline-none focus:border-accent-violet transition-all font-medium leading-relaxed" />
                        </div>
                        ...
                        <div className="pt-8 border-t border-white/10">
                          ...
                          {!editingExp ? (
                            ...
                            <div className="space-y-8">
                              <div className="relative group aspect-video glass bg-white/5 border border-dashed border-white/20 rounded-[32px] flex flex-col items-center justify-center overflow-hidden hover:border-accent-blue/50 transition-all duration-500">
